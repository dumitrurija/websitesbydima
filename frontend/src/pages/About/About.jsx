...
const About = () => {
  return (
    <section id="about">
      <AboutSection image={aboutImgs.about_welcome_img} title="About Us" description="Welcome to SquareUp, where collaboration, expertise, and client-centricity intersect to shape the future of digital innovation." />
      <Info />
      <Points data={data} />
    </section>
  )
